...
var _user$project$GameList$decoderError = F2(
	function (model, error) {
		var _p0 = A2(_elm_lang$core$Debug$log, 'Decoder error', error);
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$GameList$playerHtml = F2(
	function (i, player) {
		var _p1 = _elm_lang$core$Native_Utils.eq(player.name, '') ? {ctor: '_Tuple2', _0: 'game-list__player game-list__player--waiting', _1: '-----'} : {ctor: '_Tuple2', _0: 'game-list__player', _1: player.name};
		var cls = _p1._0;
		var txt = _p1._1;
		var _p2 = A2(_elm_lang$core$Debug$log, 'player', player);
		return A2(
...
var _user$project$GameList$players = function (players_) {
	return A2(_elm_lang$core$List$indexedMap, _user$project$GameList$playerHtml, players_);
};
var _user$project$GameList$games = function (model) {
	return _elm_lang$core$List$isEmpty(model.pendingGames) ? {
		ctor: '::',
		_0: A2(
		...
		function (game) {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('game-list__game'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href(
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									model.locale,
									A2(_elm_lang$core$Basics_ops['++'], '/games/', game.id)))),
						_1: {ctor: '[]'}
					}
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('game__visual'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
								...
								_elm_lang$html$Html$img,
								{
									...
									_0: _elm_lang$html$Html_Attributes$src(
										A2(
											_elm_lang$core$Basics_ops['++'],
											'/images/',
											A2(_elm_lang$core$Basics_ops['++'], game.theme, '/1.svg'))),
									_1: {ctor: '[]'}
								},
								{ctor: '[]'}),
							_1: {
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(game.size),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('game__players'),
								_1: {ctor: '[]'}
							},
							_user$project$GameList$players(game.players)),
						_1: {ctor: '[]'}
					}
				});
		},
...
var _user$project$GameList$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				_user$project$GameList$games(model)),
			_1: {ctor: '[]'}
		});
};
var _user$project$GameList$Params = F2(
	function (a, b) {
		return {host: a, locale: b};
	});
var _user$project$GameList$Game = F4(
	function (a, b, c, d) {
		return {id: a, theme: b, size: c, players: d};
	});
var _user$project$GameList$Player = function (a) {
	return {name: a};
};
var _user$project$GameList$playerDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$GameList$Player,
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string));
var _user$project$GameList$gameDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$GameList$Game,
	...
	A2(
		...
		'players',
		_elm_lang$core$Json_Decode$list(_user$project$GameList$playerDecoder)));
var _user$project$GameList$UpdateData = function (a) {
	return {games: a};
};
var _user$project$GameList$updateDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$GameList$UpdateData,
	A2(
		_elm_lang$core$Json_Decode$field,
		'games',
		_elm_lang$core$Json_Decode$list(_user$project$GameList$gameDecoder)));
var _user$project$GameList$Model = F4(
	function (a, b, c, d) {
		return {locale: a, pendingGames: b, activeGames: c, phxSocket: d};
	});
var _user$project$GameList$PhoenixMsg = function (a) {
	return {ctor: 'PhoenixMsg', _0: a};
};
var _user$project$GameList$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.phxSocket, _user$project$GameList$PhoenixMsg),
			_1: {ctor: '[]'}
		});
};
var _user$project$GameList$update = F2(
	function (msg, model) {
		var _p3 = msg;
		if (_p3.ctor === 'Update') {
			var _p4 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$GameList$updateDecoder, _p3._0);
			if (_p4.ctor === 'Ok') {
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{pendingGames: _p4._0.games}),
					{ctor: '[]'});
			} else {
				return A2(_user$project$GameList$decoderError, model, _p4._0);
			}
		} else {
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{phxSocket: phxSocket}),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$GameList$PhoenixMsg, phxCmd)
			};
		}
	});
var _user$project$GameList$Update = function (a) {
	return {ctor: 'Update', _0: a};
};
var _user$project$GameList$init = function (_p6) {
	var _p7 = _p6;
	var socketInit = A4(
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
		'update',
		'game-list',
		_user$project$GameList$Update,
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$init(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'ws://',
				A2(_elm_lang$core$Basics_ops['++'], _p7.host, '/socket/websocket'))));
	var payload = _elm_lang$core$Json_Encode$object(
		{ctor: '[]'});
	var channel = A2(
		_fbonetti$elm_phoenix_socket$Phoenix_Channel$withPayload,
		payload,
		_fbonetti$elm_phoenix_socket$Phoenix_Channel$init('game-list'));
	var _p8 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$join, channel, socketInit);
...
var _user$project$GameList$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$GameList$init, view: _user$project$GameList$view, update: _user$project$GameList$update, subscriptions: _user$project$GameList$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (host) {
			return A2(
...
if (typeof _user$project$GameList$main !== 'undefined') {
    _user$project$GameList$main(Elm['GameList'], 'GameList', undefined);
}
